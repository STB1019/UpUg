...
\begin{frame}{Exercise}
	\begin{enumerate}
		\item<1-> download the html page \code{http://artificial-intelligence.unibs.it/didattica-IA/?page_id=10}
		\item<2-> save the just downloaded page with \mdQuote{AIslides.html}
		...
		\item<5-> Search every link of PDF file in the downloaded page (Hint: use \code{grep} as explained before by matching the PDF extension: every PDF has it!);
